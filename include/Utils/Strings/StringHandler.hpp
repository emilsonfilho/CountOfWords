 ...
 */
template <typename Object> struct SetWidthAtLeft {
   ...
   */
  SetWidthAtLeft(const Object &o, size_t w) : obj(o), width(w) {}
};
...
/**
 * @brief Determines the "size" or display width of an object, accounting for
 * UTF-8 characters.
 * @tparam Object The type of the object.
 * @param obj The object whose size is to be determined.
 * @return The display width (number of grapheme clusters) of the object's
 * string representation.
 */
template <typename Object> size_t size(const Object &obj);

/**
 * @brief Overloads the stream insertion operator to apply SetWidthAtLeft
 * formatting.
