 ...
 *
 * This structure encapsulates the necessary parameters passed via the CLI to configure
 * the program's behavior, including input file and dictionary settings.
 */
struct CLIOptions {
    /**
