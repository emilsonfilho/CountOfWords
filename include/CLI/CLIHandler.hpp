 ...
 *
 * This class is responsible for interpreting the arguments passed to the program,
 * validating them, and initiating the execution based on the provided options.
 */
class CLIHandler {
    /**
