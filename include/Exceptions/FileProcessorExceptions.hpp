 ...
 * @brief Exception thrown when the required locale is not available on the system.
 *
 * This class inherits from std::runtime_error and is used to indicate that
 * the system is missing the necessary locale configuration to run the program properly.
 * The error message includes suggested terminal commands to generate and update the locale.
 */
...
public:
     ...
     *
     * Initializes the exception with a message guiding the user to generate the missing locale.
     */
