...
struct RedBlackNode : public Node<Key, Value> {
     ...
     * 
     * This class extends the generic Node class and includes additional properties
     * specific to Red-Black Trees, such as color and self-referencing pointers for
